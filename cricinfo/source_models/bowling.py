...
class BowlingDetails(CCBaseModel):
    ...
    pitch_map_lhb_raw: Optional[list[list[list[int]]]] = Field(default=None, 
                                                               validation_alias=AliasChoices('pitch_map_lhb_raw', 'pitchMapLhb'))
    pitch_map_rhb_raw: Optional[list[list[list[int]]]] = Field(default=None, 
                                                               validation_alias=AliasChoices('pitch_map_rhb_raw', 'pitchMapRhb'))
    ...
    def _generate_pitch_map(pitch_map_fields: list[str], pitch_map_length_fields: list[str],
